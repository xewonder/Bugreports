...
const { FiArrowLeft, FiEdit3, FiTrash2, FiCheckCircle, FiAlertCircle, FiX, FiLoader, FiMessageCircle, FiThumbsUp, FiPaperclip } = FiIcons;
    ...
    return (
      <div>
        ...
        <div className="p-6 text-center">
          ...
          <Link to="/bugs" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
      ...
      <div className="p-6">
        ...
        >
          <div className="flex items-center space-x-4">
            <Link to="/bugs" className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
