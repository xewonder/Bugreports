...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  { path: '/roadmap', icon: FiMap, label: 'Roadmap', contentType: ['roadmap', 'roadmap_comment'] },
  { path: '/bugs', icon: FiBug, label: 'Bug Reports', contentType: ['bug', 'bug_comment'] },
  { path: '/create-bug', icon: FiPlus, label: 'Report Bug', hideCounter: true },
  { path: '/features', icon: FiStar, label: 'Feature Requests', contentType: ['feature', 'feature_comment'] },
  { path: '/prompts', icon: FiCommand, label: 'Power Prompts', contentType: ['power_prompt', 'power_prompt_comment'] },
  { path: '/tips', icon: FiLightbulb, label: 'Tips & Tricks', contentType: ['tip', 'tip_comment'] },
  { path: '/general-talk', icon: FiMessageCircle, label: 'General Talk', contentType: ['general_topic', 'general_topic_comment'] },
  { path: '/help', icon: FiHelpCircle, label: 'Help Center', hideCounter: true },
      ...
      <motion.div
        ...
        <nav className="mt-6"> 
          ...
          <Link
            key={item.path}
            to={item.path}
            className={`flex items-center px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors relative ${location.pathname === item.path ? 'bg-blue-50 text-blue-600 border-r-2 border-blue-600' : ''}`}>
